...
::: tip 说明
VitePress 是一个仅支持 ESM 的软件包。不要使用 `require()` 来导入它，请参考 [Vite 的故障排除指南](https://cn.vitejs.dev/guide/troubleshooting#this-package-is-esm-only)
...
- [vite 备用官网](https://vitejs.cn/)

- [Vuepress 的主题](https://github.com/alex8088/vitepress-theme-vue)
